...
const MapChart = ({ onStateClick, selectedState }) => {
  ...
  return (
    <div className="relative max-w-5xl mx-auto h-[600px] bg-gradient-map rounded-xl shadow-lg overflow-hidden">
      <ComposableMap
        projection="geoMercator"
        projectionConfig={{
          scale: 900,              // adjust scale to fit neatly
          center: [82, 22],        // recenter on India
        }}
                ...
                <Geography
                  ...
                  style={{
                    ...
                    hover: {
                      ...
                      filter:
                        "drop-shadow(0 8px 16px rgba(0,0,0,0.25)) brightness(1.05)",
